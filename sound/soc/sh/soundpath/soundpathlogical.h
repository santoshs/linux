...
typedef int (*sndp_dai_trigger)(struct snd_pcm_substream *, int, struct snd_soc_dai *);
typedef int (*sndp_dai_hw_params)(struct snd_pcm_substream *, struct snd_pcm_hw_params *, struct snd_soc_dai *);
