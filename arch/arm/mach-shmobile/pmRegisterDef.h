...
#define SCU_INVALL					0x0C						/* SCU Invalidate All Register in Secure State Register(WO)	*/
...
#define CPG_FRQCRAPhys				0xE6150000					/* Frequency control register A					*/
#define CPG_FRQCRBPhys				0xE6150004					/* Frequency control register B					*/
#define CPG_FRQCRDPhys				0xE61500E4					/* Frequency control register D					*/
#define CPG_Pll2crPhys				0xE615002C					/* Physical address of PLL2CR					*/

#define CPG_FRQCRA					IO_ADDRESS(CPG_FRQCRAPhys)			/* Frequency control register A					*/
#define CPG_FRQCRB					IO_ADDRESS(CPG_FRQCRBPhys)			/* Frequency control register B					*/
#define CPG_FRQCRD					IO_ADDRESS(CPG_FRQCRDPhys)			/* Frequency control register D					*/


#define CPG_Pll2xoe					0x01						/* Xtal2 Oscillation (0:Enable, 1:Disable)		*/
#define CPG_WUPCR					IO_ADDRESS(0xE6151010)					/* System-Cpu Wake Up Control Register			*/
#define CPU1_WUP					0x02						/* CPU1 Wake Up bit								*/
#define CPG_RMSTPCR4Phys				0xE6150120					/* RT module stop control register 4		*/
#define CPG_SMSTPCR2				0xE6150138					/* System module stop control register 2		*/
#define CPG_SMSTPCR4Phys				0xE6150140					/* System module stop control register 4		*/


#define CPG_MSTPSR5					IO_ADDRESS(0xE615003C)	/* Module stop status register 5 */
#define CPG_SMSTPCR5				IO_ADDRESS(0xE6150144)	/* System module stop control register 5*/


#define CPG_MSTPSR2					IO_ADDRESS(0xE6150040)		/* Module stop status register 2*/
#define CPG_MSTPSR4					IO_ADDRESS(0xE615004C)		/* Module stop status register 4*/
...
#define MSTP527						0x08000000					/* Module Stop bit 527 527(Internal RAM0)	*/

#define CPG_PSTR					IO_ADDRESS(0xE6151040)		/* System-CPU Power Status Register (ES1.0)*/
#define CPG_SCPUSTR					IO_ADDRESS(0xE6151040)		/* System-CPU Power Status Register (ES2.0) */
...
#define CPG_PCLKCR					IO_ADDRESS(0xE6151020)		/*System-CPU PERIPHCLK Control Register*/

#define FRQCRA_MASK					0x00FFFFFF
#define FRQCRB_MASK					0x00FFFFF0
...
#define RWTCNTPhys					(BaseRwdtPhys + 0x0000)					/* RCLK watchdog timer counter					*/
#define RWDTCSRAPhys				(BaseRwdtPhys + 0x0004)					/* RCLK watchdog timer control/status Register	*/
...
#define A4BC_PD						0x00000030
#define A3SP_ON						0x00020000
#define SWBCR_A4BC					0x00000030
...
/* SBSC Register							*/
/********************************************/
#define BaseSbsc1Phys				0xFE400000
#define BaseSbsc2Phys				0xFB400000

#define SBSC_SDCR0APhys				(BaseSbsc1Phys + 0x0008)			/* SDRAM Control Register 0A					*/
#define SBSC_SDWCRC0APhys			(BaseSbsc1Phys + 0x0040)			/* SDRAM Common Wait Control Register 0A		*/
#define SBSC_SDWCRC1APhys			(BaseSbsc1Phys + 0x0044)			/* SDRAM Common Wait Control Register 1A		*/
#define SBSC_SDWCR00APhys			(BaseSbsc1Phys + 0x0048)			/* SDRAM Wait Control Register 00A				*/
#define SBSC_SDWCR01APhys			(BaseSbsc1Phys + 0x004C)			/* SDRAM Wait Control Register 01A				*/
#define SBSC_SDWCR10APhys			(BaseSbsc1Phys + 0x0050)			/* SDRAM Wait Control Register 10A				*/
#define SBSC_SDWCR11APhys			(BaseSbsc1Phys + 0x0054)			/* SDRAM Wait Control Register 11A				*/

#define SBSC_SDWCRC0BPhys			(BaseSbsc2Phys + 0x0040)			/* SDRAM Common Wait Control Register 0B		*/
#define SBSC_SDWCRC1BPhys			(BaseSbsc2Phys + 0x0044)			/* SDRAM Common Wait Control Register 1B		*/
#define SBSC_SDWCR00BPhys			(BaseSbsc2Phys + 0x0048)			/* SDRAM Wait Control Register 00B				*/
#define SBSC_SDWCR01BPhys			(BaseSbsc2Phys + 0x004C)			/* SDRAM Wait Control Register 01B				*/
#define SBSC_SDWCR10BPhys			(BaseSbsc2Phys + 0x0050)			/* SDRAM Wait Control Register 10B				*/
#define SBSC_SDWCR11BPhys			(BaseSbsc2Phys + 0x0054)			/* SDRAM Wait Control Register 11B				*/
...
#define	SDMRACR0A	        0xFE400084			/* SDRAM mode register address command register 0A*/
#define	SDMRACR1A	        0xFE400088			/* SDRAM mode register address command register 1A*/
#define	SbscDramPasr2Area	0x0000FFFF			/* Bit mask to acquire target bank for PASR on DRAM0 area 0, area 1 (Bank0-15)*/
//#define	SdmracrOp		8
...
#define POWER_VSTMIA(cc, Rn, Dd, N)	.word (cc << 28) | (Rn << 16) | (POWER_DN(Dd) << 12) | ((N) * 2) | (POWER_D(Dd)) | (0x0CA00B00)
/* Only use of Restore VFP-D32 */
#define POWER_VLDMIA(cc, Rn, Dd, N)	.word (cc << 28) | (Rn << 16) | (POWER_DN(Dd) << 12) | ((N) * 2) | (POWER_D(Dd)) | (0x0CB00B00)

#define	POWERDOWN_FRQCRA			0x005BBBB0	/* I:1/12, ZG:1/48, M3:1/48, B:1/48, M1:1/48	*/
#define	POWERDOWN_FRQCRB			0x10235550	/* Z:1/2, ZTR:1/4, ZT:1/6, ZX:1/12, ZS:1/2, HP:1/12		*/
#define	POWERDOWN_FRQCRD			0x00000012	/* ZB3:1/8									*/
/*
 * ********************************************************************
