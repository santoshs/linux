...
#define	fsSaveArmCommonRegister		0x160 /* Save ARM common register */
...
#define	fsSysPowerDown				0x220 /* power down */
#define	fsSysPowerUp				0x260 /* power up */
#define	fsSetClockSystemSuspend		0x320 /* Set clock */
#ifdef VMALLOC_EXPAND
#define	fsSystemSuspendCPU0PA		0x70 /* System Suspend for CPU0 with MMU off */
