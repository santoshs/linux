...
#define	fsCoreStandby						0xE0				/* Core Standby function size				*/
...
#define	fsCoreStandbyPA						0x340				/* Core Standby function with MMU off size				*/
...
#define	ram0DramPasrSettingArea0			(ram0SetClockFrqcrd				+ 0x4)
...
#ifdef CONFIG_COMPACTION
#define	ram0DramPasrSettingArea0Phys		(ram0SetClockFrqcrdPhys			+ 0x4)
...
#define	ram0SystemSuspendRestoreCPU0Phys				(ram0SaveSdmracr1aPhys				+ 0x4)	/*Restore point after enable MMU for System Sleep with CPU0*/
#else /* !CONFIG_COMPACTION	*/
#define	ram0SystemSuspendRestoreCPU0Phys				(ram0SetClockFrqcrdPhys				+ 0x4)	/*Restore point after enable MMU for System Sleep with CPU0*/
#endif /* CONFIG_COMPACTION	*/
