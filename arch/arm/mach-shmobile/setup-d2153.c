...
__weak struct regulator_consumer_supply d2153_ldo13_supplies[] = {
	...
	REGULATOR_SUPPLY("cam_core_0", NULL), /* CAM_CORE_1.2V */ /* + */
#else /* CONFIG_MACH_LT02LTE */ /* + */
...
#if defined(CONFIG_MACH_LT02LTE) /* + */
	REGULATOR_SUPPLY("cam_core_1", NULL), /* CAM_CORE_1.8V */ /* + */
...
#if defined(CONFIG_BOARD_VERSION_LT02LTE)
		D2153_MCTL_MODE_INIT(D2153_LDO_13, 0x00, D2153_REGULATOR_OFF_IN_DSM),	// NC
#else
		/* CAM_AF */
		D2153_MCTL_MODE_INIT(D2153_LDO_13, 0x54, D2153_REGULATOR_OFF_IN_DSM),
#endif
