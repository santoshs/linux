...
#define GPIO_PORTL159_128DR		IO_ADDRESS(0xE6055000)
#define GPIO_PORTL223_192DR		IO_ADDRESS(0xE6056000)
#define GPIO_PORTL255_224DR		IO_ADDRESS(0xE6056004)
#define GPIO_PORTL287_256DR		IO_ADDRESS(0xE6056008)
#define GPIO_PORTL319_288DR		IO_ADDRESS(0xE605600C)
#define GPIO_PORTL351_320DR		IO_ADDRESS(0xE6056010)

#define GPIO_PORTL063_032DSR		IO_ADDRESS(0xE6074104)
#define GPIO_PORTL063_032DCR		IO_ADDRESS(0xE6074204)

#define GPIO_PORT0_CR	IO_ADDRESS(0xE6050000)
#define GPIO_PORT1_CR	IO_ADDRESS(0xE6050001)
#define GPIO_PORT2_CR	IO_ADDRESS(0xE6050002)
#define GPIO_PORT3_CR	IO_ADDRESS(0xE6050003)
#define GPIO_PORT4_CR	IO_ADDRESS(0xE6050004)
#define GPIO_PORT5_CR	IO_ADDRESS(0xE6050005)
#define GPIO_PORT6_CR	IO_ADDRESS(0xE6050006)
#define GPIO_PORT7_CR	IO_ADDRESS(0xE6050007)
#define GPIO_PORT8_CR	IO_ADDRESS(0xE6050008)
#define GPIO_PORT9_CR	IO_ADDRESS(0xE6050009)
#define GPIO_PORT10_CR	IO_ADDRESS(0xE605000A)
#define GPIO_PORT11_CR	IO_ADDRESS(0xE605000B)
#define GPIO_PORT12_CR	IO_ADDRESS(0xE605000C)
#define GPIO_PORT13_CR	IO_ADDRESS(0xE605000D)
#define GPIO_PORT14_CR	IO_ADDRESS(0xE605000E)
#define GPIO_PORT15_CR	IO_ADDRESS(0xE605000F)
#define GPIO_PORT16_CR	IO_ADDRESS(0xE6050010)
#define GPIO_PORT17_CR	IO_ADDRESS(0xE6050011)
#define GPIO_PORT18_CR	IO_ADDRESS(0xE6050012)
#define GPIO_PORT19_CR	IO_ADDRESS(0xE6050013)
#define GPIO_PORT20_CR	IO_ADDRESS(0xE6050014)
#define GPIO_PORT21_CR	IO_ADDRESS(0xE6050015)
#define GPIO_PORT22_CR	IO_ADDRESS(0xE6050016)
#define GPIO_PORT23_CR	IO_ADDRESS(0xE6050017)
#define GPIO_PORT24_CR	IO_ADDRESS(0xE6050018)
#define GPIO_PORT25_CR	IO_ADDRESS(0xE6050019)
#define GPIO_PORT26_CR	IO_ADDRESS(0xE605001A)
#define GPIO_PORT27_CR	IO_ADDRESS(0xE605001B)
#define GPIO_PORT28_CR	IO_ADDRESS(0xE605001C)
#define GPIO_PORT29_CR	IO_ADDRESS(0xE605001D)
#define GPIO_PORT30_CR	IO_ADDRESS(0xE605001E)
#define GPIO_PORT31_CR	IO_ADDRESS(0xE605001F)
#define GPIO_PORT32_CR	IO_ADDRESS(0xE6050020)
#define GPIO_PORT33_CR	IO_ADDRESS(0xE6050021)
#define GPIO_PORT34_CR	IO_ADDRESS(0xE6050022)
#define GPIO_PORT35_CR	IO_ADDRESS(0xE6050023)
#define GPIO_PORT36_CR	IO_ADDRESS(0xE6050024)
#define GPIO_PORT37_CR	IO_ADDRESS(0xE6050025)
#define GPIO_PORT38_CR	IO_ADDRESS(0xE6050026)
#define GPIO_PORT39_CR	IO_ADDRESS(0xE6050027)
#define GPIO_PORT40_CR	IO_ADDRESS(0xE6050028)
#define GPIO_PORT41_CR	IO_ADDRESS(0xE6050029)
#define GPIO_PORT42_CR	IO_ADDRESS(0xE605002A)
#define GPIO_PORT43_CR	IO_ADDRESS(0xE605002B)
#define GPIO_PORT44_CR	IO_ADDRESS(0xE605002C)
#define GPIO_PORT45_CR	IO_ADDRESS(0xE605002D)
#define GPIO_PORT46_CR	IO_ADDRESS(0xE605002E)
#define GPIO_PORT47_CR	IO_ADDRESS(0xE605002F)
#define GPIO_PORT48_CR	IO_ADDRESS(0xE6050030)

#define GPIO_PORT64_CR	IO_ADDRESS(0xE6050040)
#define GPIO_PORT65_CR	IO_ADDRESS(0xE6050041)
#define GPIO_PORT66_CR	IO_ADDRESS(0xE6050042)
#define GPIO_PORT67_CR	IO_ADDRESS(0xE6050043)
#define GPIO_PORT68_CR	IO_ADDRESS(0xE6050044)
#define GPIO_PORT69_CR	IO_ADDRESS(0xE6050045)
#define GPIO_PORT70_CR	IO_ADDRESS(0xE6050046)
#define GPIO_PORT71_CR	IO_ADDRESS(0xE6050047)
#define GPIO_PORT72_CR	IO_ADDRESS(0xE6050048)
#define GPIO_PORT73_CR	IO_ADDRESS(0xE6050049)
#define GPIO_PORT74_CR	IO_ADDRESS(0xE605004A)
#define GPIO_PORT75_CR	IO_ADDRESS(0xE605004B)
#define GPIO_PORT76_CR	IO_ADDRESS(0xE605004C)
#define GPIO_PORT77_CR	IO_ADDRESS(0xE605004D)
#define GPIO_PORT78_CR	IO_ADDRESS(0xE605004E)
#define GPIO_PORT79_CR	IO_ADDRESS(0xE605004F)
#define GPIO_PORT80_CR	IO_ADDRESS(0xE6050050)
#define GPIO_PORT81_CR	IO_ADDRESS(0xE6050051)
#define GPIO_PORT82_CR	IO_ADDRESS(0xE6050052)
#define GPIO_PORT83_CR	IO_ADDRESS(0xE6050053)
#define GPIO_PORT84_CR	IO_ADDRESS(0xE6050054)
#define GPIO_PORT85_CR	IO_ADDRESS(0xE6050055)
#define GPIO_PORT86_CR	IO_ADDRESS(0xE6050056)
#define GPIO_PORT87_CR	IO_ADDRESS(0xE6050057)
#define GPIO_PORT88_CR	IO_ADDRESS(0xE6050058)
#define GPIO_PORT89_CR	IO_ADDRESS(0xE6050059)
#define GPIO_PORT90_CR	IO_ADDRESS(0xE605005A)
#define GPIO_PORT91_CR	IO_ADDRESS(0xE605005B)

#define GPIO_PORT96_CR	IO_ADDRESS(0xE6050060)
#define GPIO_PORT97_CR	IO_ADDRESS(0xE6050061)
#define GPIO_PORT98_CR	IO_ADDRESS(0xE6050062)
#define GPIO_PORT99_CR	IO_ADDRESS(0xE6050063)
#define GPIO_PORT100_CR	IO_ADDRESS(0xE6050064)
#define GPIO_PORT101_CR	IO_ADDRESS(0xE6050065)
#define GPIO_PORT102_CR	IO_ADDRESS(0xE6050066)
#define GPIO_PORT103_CR	IO_ADDRESS(0xE6050067)
#define GPIO_PORT104_CR	IO_ADDRESS(0xE6050068)
#define GPIO_PORT105_CR	IO_ADDRESS(0xE6050069)
#define GPIO_PORT106_CR	IO_ADDRESS(0xE605006A)
#define GPIO_PORT107_CR	IO_ADDRESS(0xE605006B)
#define GPIO_PORT108_CR	IO_ADDRESS(0xE605006C)
#define GPIO_PORT109_CR	IO_ADDRESS(0xE605006D)
#define GPIO_PORT110_CR	IO_ADDRESS(0xE605006E)

#define GPIO_PORT128_CR	IO_ADDRESS(0xE6051080)
#define GPIO_PORT129_CR	IO_ADDRESS(0xE6051081)
#define GPIO_PORT130_CR	IO_ADDRESS(0xE6051082)
#define GPIO_PORT131_CR	IO_ADDRESS(0xE6051083)

#define GPIO_PORT133_CR	IO_ADDRESS(0xE6051085)
#define GPIO_PORT134_CR	IO_ADDRESS(0xE6051086)
#define GPIO_PORT135_CR	IO_ADDRESS(0xE6051087)
#define GPIO_PORT136_CR	IO_ADDRESS(0xE6051088)
#define GPIO_PORT137_CR	IO_ADDRESS(0xE6051089)
#define GPIO_PORT138_CR	IO_ADDRESS(0xE605108A)
#define GPIO_PORT139_CR	IO_ADDRESS(0xE605108B)
#define GPIO_PORT140_CR	IO_ADDRESS(0xE605108C)
#define GPIO_PORT141_CR	IO_ADDRESS(0xE605108D)
#define GPIO_PORT142_CR	IO_ADDRESS(0xE605108E)

#define GPIO_PORT198_CR	IO_ADDRESS(0xE60520C6)
#define GPIO_PORT199_CR	IO_ADDRESS(0xE60520C7)
#define GPIO_PORT200_CR	IO_ADDRESS(0xE60520C8)
#define GPIO_PORT201_CR	IO_ADDRESS(0xE60520C9)
#define GPIO_PORT202_CR	IO_ADDRESS(0xE60520CA)
#define GPIO_PORT203_CR	IO_ADDRESS(0xE60520CB)
#define GPIO_PORT204_CR	IO_ADDRESS(0xE60520CC)
#define GPIO_PORT205_CR	IO_ADDRESS(0xE60520CD)
#define GPIO_PORT206_CR	IO_ADDRESS(0xE60520CE)
#define GPIO_PORT207_CR	IO_ADDRESS(0xE60520CF)
#define GPIO_PORT208_CR	IO_ADDRESS(0xE60520D0)
#define GPIO_PORT209_CR	IO_ADDRESS(0xE60520D1)
#define GPIO_PORT210_CR	IO_ADDRESS(0xE60520D2)
#define GPIO_PORT211_CR	IO_ADDRESS(0xE60520D3)
#define GPIO_PORT212_CR	IO_ADDRESS(0xE60520D4)
#define GPIO_PORT213_CR	IO_ADDRESS(0xE60520D5)
#define GPIO_PORT214_CR	IO_ADDRESS(0xE60520D6)
#define GPIO_PORT215_CR	IO_ADDRESS(0xE60520D7)
#define GPIO_PORT216_CR	IO_ADDRESS(0xE60520D8)
#define GPIO_PORT217_CR	IO_ADDRESS(0xE60520D9)
#define GPIO_PORT218_CR	IO_ADDRESS(0xE60520DA)
#define GPIO_PORT219_CR	IO_ADDRESS(0xE60520DB)

#define GPIO_PORT224_CR	IO_ADDRESS(0xE60520E0)
#define GPIO_PORT225_CR	IO_ADDRESS(0xE60520E1)
#define GPIO_PORT226_CR	IO_ADDRESS(0xE60520E2)
#define GPIO_PORT227_CR	IO_ADDRESS(0xE60520E3)
#define GPIO_PORT228_CR	IO_ADDRESS(0xE60520E4)
#define GPIO_PORT229_CR	IO_ADDRESS(0xE60520E5)
#define GPIO_PORT230_CR	IO_ADDRESS(0xE60520E6)
#define GPIO_PORT231_CR	IO_ADDRESS(0xE60520E7)
#define GPIO_PORT232_CR	IO_ADDRESS(0xE60520E8)
#define GPIO_PORT233_CR	IO_ADDRESS(0xE60520E9)
#define GPIO_PORT234_CR	IO_ADDRESS(0xE60520EA)
#define GPIO_PORT235_CR	IO_ADDRESS(0xE60520EB)
#define GPIO_PORT236_CR	IO_ADDRESS(0xE60520EC)
#define GPIO_PORT237_CR	IO_ADDRESS(0xE60520ED)
#define GPIO_PORT238_CR	IO_ADDRESS(0xE60520EE)
#define GPIO_PORT239_CR	IO_ADDRESS(0xE60520EF)
#define GPIO_PORT240_CR	IO_ADDRESS(0xE60520F0)
#define GPIO_PORT241_CR	IO_ADDRESS(0xE60520F1)
#define GPIO_PORT242_CR	IO_ADDRESS(0xE60520F2)
#define GPIO_PORT243_CR	IO_ADDRESS(0xE60520F3)
#define GPIO_PORT244_CR	IO_ADDRESS(0xE60520F4)
#define GPIO_PORT245_CR	IO_ADDRESS(0xE60520F5)
#define GPIO_PORT246_CR	IO_ADDRESS(0xE60520F6)
#define GPIO_PORT247_CR	IO_ADDRESS(0xE60520F7)
#define GPIO_PORT248_CR	IO_ADDRESS(0xE60520F8)
#define GPIO_PORT249_CR	IO_ADDRESS(0xE60520F9)
#define GPIO_PORT250_CR	IO_ADDRESS(0xE60520FA)
#define GPIO_PORT251_CR	IO_ADDRESS(0xE60520FB)
#define GPIO_PORT252_CR	IO_ADDRESS(0xE60520FC)
#define GPIO_PORT253_CR	IO_ADDRESS(0xE60520FD)
#define GPIO_PORT254_CR	IO_ADDRESS(0xE60520FE)
#define GPIO_PORT255_CR	IO_ADDRESS(0xE60520FF)
#define GPIO_PORT256_CR	IO_ADDRESS(0xE6052100)
#define GPIO_PORT257_CR	IO_ADDRESS(0xE6052101)
#define GPIO_PORT258_CR	IO_ADDRESS(0xE6052102)
#define GPIO_PORT259_CR	IO_ADDRESS(0xE6052103)
#define GPIO_PORT260_CR	IO_ADDRESS(0xE6052104)
#define GPIO_PORT261_CR	IO_ADDRESS(0xE6052105)
#define GPIO_PORT262_CR	IO_ADDRESS(0xE6052106)
#define GPIO_PORT263_CR	IO_ADDRESS(0xE6052107)
#define GPIO_PORT264_CR	IO_ADDRESS(0xE6052108)
#define GPIO_PORT265_CR	IO_ADDRESS(0xE6052109)
#define GPIO_PORT266_CR	IO_ADDRESS(0xE605210A)
#define GPIO_PORT267_CR	IO_ADDRESS(0xE605210B)
#define GPIO_PORT268_CR	IO_ADDRESS(0xE605210C)
#define GPIO_PORT269_CR	IO_ADDRESS(0xE605210D)
#define GPIO_PORT270_CR	IO_ADDRESS(0xE605210E)
#define GPIO_PORT271_CR	IO_ADDRESS(0xE605210F)
#define GPIO_PORT272_CR	IO_ADDRESS(0xE6052110)
#define GPIO_PORT273_CR	IO_ADDRESS(0xE6052111)
#define GPIO_PORT274_CR	IO_ADDRESS(0xE6052112)
#define GPIO_PORT275_CR	IO_ADDRESS(0xE6052113)
#define GPIO_PORT276_CR	IO_ADDRESS(0xE6052114)
#define GPIO_PORT277_CR	IO_ADDRESS(0xE6052115)

#define GPIO_PORT288_CR	IO_ADDRESS(0xE6052120)
#define GPIO_PORT289_CR	IO_ADDRESS(0xE6052121)
#define GPIO_PORT290_CR	IO_ADDRESS(0xE6052122)
#define GPIO_PORT291_CR	IO_ADDRESS(0xE6052123)
#define GPIO_PORT292_CR	IO_ADDRESS(0xE6052124)
#define GPIO_PORT293_CR	IO_ADDRESS(0xE6052125)
#define GPIO_PORT294_CR	IO_ADDRESS(0xE6052126)
#define GPIO_PORT295_CR	IO_ADDRESS(0xE6052127)
#define GPIO_PORT296_CR	IO_ADDRESS(0xE6052128)
#define GPIO_PORT297_CR	IO_ADDRESS(0xE6052129)
#define GPIO_PORT298_CR	IO_ADDRESS(0xE605212A)
#define GPIO_PORT299_CR	IO_ADDRESS(0xE605212B)
#define GPIO_PORT300_CR	IO_ADDRESS(0xE605212C)
#define GPIO_PORT301_CR	IO_ADDRESS(0xE605212D)
#define GPIO_PORT302_CR	IO_ADDRESS(0xE605212E)
#define GPIO_PORT303_CR	IO_ADDRESS(0xE605212F)
#define GPIO_PORT304_CR	IO_ADDRESS(0xE6052130)
#define GPIO_PORT305_CR	IO_ADDRESS(0xE6052131)
#define GPIO_PORT306_CR	IO_ADDRESS(0xE6052132)
#define GPIO_PORT307_CR	IO_ADDRESS(0xE6052133)
#define GPIO_PORT308_CR	IO_ADDRESS(0xE6052134)
#define GPIO_PORT309_CR	IO_ADDRESS(0xE6052135)
#define GPIO_PORT310_CR	IO_ADDRESS(0xE6052136)
#define GPIO_PORT311_CR	IO_ADDRESS(0xE6052137)
#define GPIO_PORT312_CR	IO_ADDRESS(0xE6052138)

#define GPIO_PORT320_CR	IO_ADDRESS(0xE6052140)
#define GPIO_PORT321_CR	IO_ADDRESS(0xE6052141)
#define GPIO_PORT322_CR	IO_ADDRESS(0xE6052142)
#define GPIO_PORT323_CR	IO_ADDRESS(0xE6052143)
#define GPIO_PORT324_CR	IO_ADDRESS(0xE6052144)
#define GPIO_PORT325_CR	IO_ADDRESS(0xE6052145)
#define GPIO_PORT326_CR	IO_ADDRESS(0xE6052146)
#define GPIO_PORT327_CR	IO_ADDRESS(0xE6052147)
...
#define BT_WAKE_GPIO_CR	GPIO_PORT262_CR
/**
 * SDHI
 */
#define SDHI1_CLK_CR	GPIO_PORT288_CR
#define SDHI1_CMD_CR	GPIO_PORT293_CR
#define SDHI1_D0_CR	GPIO_PORT289_CR
#define SDHI1_D1_CR	GPIO_PORT290_CR
#define SDHI1_D2_CR	GPIO_PORT291_CR
#define SDHI1_D3_CR	GPIO_PORT292_CR
...
#define SYSC_LPMWUMON	IO_ADDRESS(0xE6180084)
#define EXSTMON2		IO_ADDRESS(0xE6180088)
#define EXSTMON1		IO_ADDRESS(0xE618008C)
#define SYSC_LPMWUMSKMON	IO_ADDRESS(0xE6180090)
#define SYSC_WUPRFAC		IO_ADDRESS(0xE6180094)
#define SYSC_WUPSFAC		IO_ADDRESS(0xE6180098)
#define SYSC_WUPMFAC		IO_ADDRESS(0xE618009C)
#define SYSC_RWBCR		IO_ADDRESS(0xE6180200)

#define SYSC_SWBCR		IO_ADDRESS(0xE6180204)
...
#define SYSC_WUPRCR			IO_ADDRESS(0xE6180260)
#define SYSC_WUPSCR			IO_ADDRESS(0xE6180264)
