/*
 * arch/arm/mach-shmobile/include/mach/board-lt02lte-config.h
 *
...
#ifndef __ASM_ARCH_BOARD_LT02LTE_CONFIG_H
#define __ASM_ARCH_BOARD_LT02LTE_CONFIG_H
...
static struct fsi_d2153_platform_data lt02lte_audio_pdata = {
	.gpio_spkr_en		= -1,
...
static struct platform_device lt02lte_audio_device = {
	.name	= "fsi-snd-d2153",
	.id	= 0,
	.dev	= {
		.platform_data  = &lt02lte_audio_pdata,
	},
};
...
/* THREE optional lt02lte_devices pointer lists for initializing the platform
 * devices
 */
 ...
 * boot_command_line parameter stm=0/1/n
 */
static struct platform_device *lt02lte_devices_stm_sdhi1[] __initdata = {
...
static struct platform_device *lt02lte_devices_stm_sdhi0[] __initdata = {
...
static struct platform_device *lt02lte_devices_stm_none[] __initdata = {
