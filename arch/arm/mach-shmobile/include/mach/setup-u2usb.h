...
#define USB_SPWDAT		IO_ADDRESS(HSUSB_BASEPhys + 0x013A)
#define USB_SPCTRL		IO_ADDRESS(HSUSB_BASEPhys + 0x013C)
#define USB_SPRDAT		IO_ADDRESS(HSUSB_BASEPhys + 0x013E)
#define USB_SPEXADDR		IO_ADDRESS(HSUSB_BASEPhys + 0x0140)
#define USB_SPWR		0x0001
#define USB_SPRD		0x0002
#define USB_SPADDR		IO_ADDRESS(HSUSB_BASEPhys + 0x0138)
