...
#if 0 /* waiting for IRQC code */
#define PORT_IRQ(pfx, irq)	{ GPIO_PORT##pfx, irq }
static struct pinmux_gpio_irq pinmux_irqs[] = {
	PORT_IRQ(0, irqpin2irq(0)),
	PORT_IRQ(1, irqpin2irq(1)),
	PORT_IRQ(2, irqpin2irq(2)),
	PORT_IRQ(3, irqpin2irq(3)),
	PORT_IRQ(4, irqpin2irq(4)),
	PORT_IRQ(5, irqpin2irq(5)),
	PORT_IRQ(6, irqpin2irq(6)),
	PORT_IRQ(7, irqpin2irq(7)),
	PORT_IRQ(8, irqpin2irq(8)),
	PORT_IRQ(9, irqpin2irq(9)),
	PORT_IRQ(10, irqpin2irq(10)),
	PORT_IRQ(11, irqpin2irq(11)),
	PORT_IRQ(12, irqpin2irq(12)),
	PORT_IRQ(13, irqpin2irq(13)),
	PORT_IRQ(14, irqpin2irq(14)),
	PORT_IRQ(15, irqpin2irq(15)),
	PORT_IRQ(16, irqpin2irq(16)),
	PORT_IRQ(17, irqpin2irq(17)),
	PORT_IRQ(18, irqpin2irq(18)),
	PORT_IRQ(19, irqpin2irq(19)),
	PORT_IRQ(20, irqpin2irq(20)),
	PORT_IRQ(21, irqpin2irq(21)),
	PORT_IRQ(22, irqpin2irq(22)),
	PORT_IRQ(23, irqpin2irq(23)),
	PORT_IRQ(24, irqpin2irq(24)),
	PORT_IRQ(25, irqpin2irq(25)),
	PORT_IRQ(26, irqpin2irq(26)),
	PORT_IRQ(27, irqpin2irq(27)),
	PORT_IRQ(28, irqpin2irq(28)),
	PORT_IRQ(29, irqpin2irq(29)),
	PORT_IRQ(30, irqpin2irq(30)),
	PORT_IRQ(31, irqpin2irq(31)),
	PORT_IRQ(32, irqpin2irq(32)),
	PORT_IRQ(33, irqpin2irq(33)),
	PORT_IRQ(34, irqpin2irq(34)),
	PORT_IRQ(35, irqpin2irq(35)),
	PORT_IRQ(36, irqpin2irq(36)),
	PORT_IRQ(37, irqpin2irq(37)),
	PORT_IRQ(38, irqpin2irq(38)),
	PORT_IRQ(39, irqpin2irq(39)),
	PORT_IRQ(59, irqpin2irq(59)),
	PORT_IRQ(40, irqpin2irq(40)),
	PORT_IRQ(41, irqpin2irq(41)),
	PORT_IRQ(42, irqpin2irq(42)),
	PORT_IRQ(43, irqpin2irq(43)),
	PORT_IRQ(44, irqpin2irq(44)),
	PORT_IRQ(45, irqpin2irq(45)),
	PORT_IRQ(46, irqpin2irq(46)),
	PORT_IRQ(47, irqpin2irq(47)),
	PORT_IRQ(48, irqpin2irq(48)),
	PORT_IRQ(49, irqpin2irq(49)),
	PORT_IRQ(60, irqpin2irq(60)),
	PORT_IRQ(52, irqpin2irq(52)),
	PORT_IRQ(53, irqpin2irq(53)),
	PORT_IRQ(54, irqpin2irq(54)),
	PORT_IRQ(55, irqpin2irq(55)),
	PORT_IRQ(56, irqpin2irq(56)),
	PORT_IRQ(57, irqpin2irq(57)),
	PORT_IRQ(58, irqpin2irq(58)),
	PORT_IRQ(51, irqpin2irq(51)),
	PORT_IRQ(50, irqpin2irq(50)),
};
#endif
