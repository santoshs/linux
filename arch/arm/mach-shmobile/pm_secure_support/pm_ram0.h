...
#define	fsSysPowerDown						0x200				/* power down function size					*/
#define	fsSysPowerUp						0x220				/* power up function size					*/
#define	fsSetClockSystemSuspend				0x300				/* Set clock function size					*/
