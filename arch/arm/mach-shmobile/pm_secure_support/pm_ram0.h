...
#define	fsCoreStandby						0x1E0				/* Core Standby function size				*/
...
#define	fsSysPowerUp						0x260				/* power up function size					*/
...
#define	fsCoreStandbyPA						0x3C0				/* Core Standby function with MMU off size				*/
...
#define	ram0SecHalPhys						\
(ram0SecHalCommaEntryPhys		+ 0x4)
#define ram0SecHalvaluePhys					\
(ram0SecHalPhys					+ 0x4)

#define	ram0DramPasrSettingArea0Phys		\
(ram0SecHalvaluePhys		+ 0x4)
