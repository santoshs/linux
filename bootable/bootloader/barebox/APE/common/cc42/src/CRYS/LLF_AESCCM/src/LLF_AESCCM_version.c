  ...
  /*
   *  Object %LLF_AESCCM_version.c    : %
   *  State           :  %state%
   *  Creation date   :  16 Sept 2008
   *  Last modified   :  %modify_time%
   */
  /** @file
   *  \brief This file contains a function, getting the current version of LLF AESCCM.
   *
   *  \version LLF_AESCCM_version.c.#1:csrc:1
   *  \author R.levin
...
#define LLF_AESCCM_RELEASE_TYPE       CRYS_DEFS_CC_6_ENGINE_TYPE
#define LLF_AESCCM_MAGOR_VERSION_NUM     6
#define LLF_AESCCM_MINOR_VERSION_NUM     0
#define LLF_AESCCM_SUB_VERSION_NUM       0
#define LLF_AESCCM_INTERNAL_VERSION_NUM  0
 ...
 */
 ...
 void  LLF_AESCCM_GetVersion(CRYS_ComponentVersion_t *version_ptr)
 {
    ...
    version_ptr->type     = LLF_AESCCM_RELEASE_TYPE;
    version_ptr->major    = LLF_AESCCM_MAGOR_VERSION_NUM;
    version_ptr->minor    = LLF_AESCCM_MINOR_VERSION_NUM;
    version_ptr->sub      = LLF_AESCCM_SUB_VERSION_NUM;
    version_ptr->internal = LLF_AESCCM_INTERNAL_VERSION_NUM;

    return;

 }/* END OF LLF_AESCCM_GetVersion */
