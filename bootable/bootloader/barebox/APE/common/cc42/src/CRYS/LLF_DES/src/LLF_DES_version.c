...
#define LLF_DES_RELEASE_TYPE       CRYS_DEFS_CC_6_ENGINE_TYPE
#define LLF_DES_MAGOR_VERSION_NUM     6
#define LLF_DES_MINOR_VERSION_NUM     0
#define LLF_DES_SUB_VERSION_NUM       1
#define LLF_DES_INTERNAL_VERSION_NUM  0
 ...
 */
 ...
 void  LLF_DES_GetVersion(CRYS_ComponentVersion_t *version_ptr)
 {
    /* LOCAL DECLERATIONS */
    ...
    version_ptr->compName[0] = 'D';
    version_ptr->compName[1] = 'E';
    version_ptr->compName[2] = 'S';
    version_ptr->compName[3] = 0;

    version_ptr->type     = LLF_DES_RELEASE_TYPE;
    version_ptr->major    = LLF_DES_MAGOR_VERSION_NUM;
    version_ptr->minor    = LLF_DES_MINOR_VERSION_NUM;
    version_ptr->sub      = LLF_DES_SUB_VERSION_NUM;
    version_ptr->internal = LLF_DES_INTERNAL_VERSION_NUM;
