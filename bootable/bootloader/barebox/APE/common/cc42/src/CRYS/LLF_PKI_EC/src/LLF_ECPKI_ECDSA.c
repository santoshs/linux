...
*/
CRYSError_t LLF_ECDSA_SignCalc(  CRYS_ECPKI_PrivKey_t   *SignerPrivateKey_ptr,      /*in*/
								 ...
								 DxUint32_t             *TempBuff_ptr               /*in*/ )
{
   ...
   DxUint32_t  modSizeInBits, modSizeInBytes, modSizeInWords, ordSizeInBytes;
   ...
   *TempBuff_ptr = *TempBuff_ptr;
   ...
   LLF_PKI_PKA_SetRegSize( Domain_ptr->EC_OrderSizeInBits+32, LenID_r+1, VirtualHwBaseAddr );
    ...
    LLF_PKI_PKA_CopyDataIntoPkaReg( rN/*dstReg*/, LenID_r+1, (DxUint8_t*)&(Domain_ptr->GF_Modulus)/*src_ptr*/,
                                    modSizeInBytes, VirtualHwBaseAddr );
    LLF_PKI_PKA_CopyDataIntoPkaReg( rNp/*dstReg*/, LenID_r+1, (DxUint8_t*)(SignerPrivateKey_ptr->LLF.NP)/*src_ptr*/,
                                    4*LLF_PKI_PKA_BARRETT_MOD_TAG_BUFF_SIZE_IN_WORDS, VirtualHwBaseAddr );

    /* EC order and its Barrett tag */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rR/*dstReg*/, LenID_r+1, (DxUint8_t*)&(Domain_ptr->EC_GenerOrder)/*src_ptr*/,
                                    ordSizeInBytes, VirtualHwBaseAddr );
    LLF_PKI_PKA_CopyDataIntoPkaReg( rRp/*dstReg*/, LenID_r+1, (DxUint8_t*)(SignerPrivateKey_ptr->LLF.RP)/*src_ptr*/,
                                    4*LLF_PKI_PKA_BARRETT_MOD_TAG_BUFF_SIZE_IN_WORDS, VirtualHwBaseAddr );

    /* private key */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rS/*dstReg*/, LenID_r+1, (DxUint8_t*)&(SignerPrivateKey_ptr->PrivKey)/*src_ptr*/,
                                    ordSizeInBytes, VirtualHwBaseAddr );
    /* message representative rF */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rF/*dstReg*/, LenID_r+1, (DxUint8_t*)MessageRepresent_ptr/*src_ptr*/,
                                    min(ordSizeInBytes, 4*MessageRepresentSizeWords), VirtualHwBaseAddr );
   ...
   while(1)
   {
		...
		return LLF_ECDSA_SIGN_CALC_CANNOT_CREATE_SIGNATURE;
			...
			Error = LLF_ECPKI_GenKeyPair( DomainID,	rU/*ephemer.priv*/, &V/*ephemer.publ*/,
						                  regTemps+9, 28-9/*countTemps*/, (DxUint8_t*)TempBuff_ptr,
		...
		return LLF_ECDSA_SIGN_CALC_CANNOT_CREATE_SIGNATURE;
            ...
            LLF_PKI_PKA_CopyDataIntoPkaReg( rU/*dstReg*/, LenID_r+1, (DxUint8_t *)EphemerKeyData_ptr/*src_ptr*/,
                                ordSizeInBytes, VirtualHwBaseAddr );

			/* copy ephemeral public Key X */
            LLF_PKI_PKA_CopyDataIntoPkaReg(
                       V.rX/*dstReg*/, LenID_r+1, (DxUint8_t *)EphemerKeyData_ptr + 4*(modSizeInWords + 1 )/*src_ptr*/,
                       modSizeInBytes, VirtualHwBaseAddr );
   ...
   LLF_PKI_PKA_CopyDataFromPkaReg( (DxUint8_t *)SignatureC_ptr,  min(modSizeInBytes, ordSizeInBytes),
                                       V.rX/*srcReg*/, VirtualHwBaseAddr );
   LLF_PKI_PKA_CopyDataFromPkaReg( (DxUint8_t *)SignatureD_ptr,  ordSizeInBytes,
...

 {
   ...
   *TempBuff_ptr = *TempBuff_ptr;
   ...
   LLF_PKI_PKA_SetRegSize( Domain_ptr->EC_OrderSizeInBits+32, LenID_r+1, VirtualHwBaseAddr );
    ...
    LLF_PKI_PKA_CopyDataIntoPkaReg( rR/*dstReg*/, LenID_r+1, (DxUint8_t*)&(Domain_ptr->EC_GenerOrder)/*src_ptr*/,
                                    ordSizeInBytes, VirtualHwBaseAddr );
    LLF_PKI_PKA_CopyDataIntoPkaReg( rRp/*dstReg*/, LenID_r+1, (DxUint8_t*)(SignerPublKey_ptr->LLF.RP)/*src_ptr*/,
                                    4*LLF_ECPKI_PKA_BARRETT_MOD_TAG_BUFF_SIZE_IN_WORDS, VirtualHwBaseAddr );

    /* save modulus and its Barrett tag */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rN/*dstReg*/, LenID_r+1, (DxUint8_t*)&(Domain_ptr->GF_Modulus)/*src_ptr*/,
                                    modSizeInBytes, VirtualHwBaseAddr );
    LLF_PKI_PKA_CopyDataIntoPkaReg( rNp/*dstReg*/, LenID_r+1, (DxUint8_t*)(SignerPublKey_ptr->LLF.NP)/*src_ptr*/,
                                    4*LLF_ECPKI_PKA_BARRETT_MOD_TAG_BUFF_SIZE_IN_WORDS, VirtualHwBaseAddr );

    /* signature C */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rC/*dstReg*/, LenID_r+1, (DxUint8_t*)SignatureC_ptr/*src_ptr*/,
                                    min(modSizeInBytes, ordSizeInBytes), VirtualHwBaseAddr );
    /* signature D */
    LLF_PKI_PKA_CopyDataIntoPkaReg( rD/*dstReg*/, LenID_r+1, (DxUint8_t*)SignatureD_ptr/*src_ptr*/,
                                    ordSizeInBytes, VirtualHwBaseAddr );
    ...
    /* P1 =  h1*G */
    LLF_ECPKI_SetPoint( (DxUint8_t *)(Domain_ptr->EC_Gener_X)/*X*/,
                        (DxUint8_t *)(Domain_ptr->EC_Gener_Y)/*Y*/, DX_NULL/*Z*/,
                        modSizeInBytes, LenID_r, &P1/*Res*/, EC_PointJacobian, VirtualHwBaseAddr );
    ...
    /* 3.2. P2 =  h2*W */
    LLF_ECPKI_SetPoint( (DxUint8_t *)(SignerPublKey_ptr->PublKeyX)/*X*/,
                        (DxUint8_t *)(SignerPublKey_ptr->PublKeyY)/*Y*/, DX_NULL/*Z*/,
                        modSizeInBytes, LenID_r, &P2/*Res*/, EC_PointJacobian, VirtualHwBaseAddr );
