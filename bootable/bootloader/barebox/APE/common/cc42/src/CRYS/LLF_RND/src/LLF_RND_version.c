...
#define LLF_RND_RELEASE_TYPE       CRYS_DEFS_CC_6_ENGINE_TYPE
#define LLF_RND_MAGOR_VERSION_NUM     6
#define LLF_RND_MINOR_VERSION_NUM     3
#define LLF_RND_SUB_VERSION_NUM       1
#define LLF_RND_INTERNAL_VERSION_NUM  0
 ...
 */
 ...
 void  LLF_RND_GetVersion(CRYS_ComponentVersion_t *version_ptr)
 {
    ...
    version_ptr->compName[1] = 'N';
    version_ptr->compName[2] = 'D';
    version_ptr->compName[3] = 0;

    version_ptr->type     = LLF_RND_RELEASE_TYPE;
    version_ptr->major    = LLF_RND_MAGOR_VERSION_NUM;
    version_ptr->minor    = LLF_RND_MINOR_VERSION_NUM;
    version_ptr->sub      = LLF_RND_SUB_VERSION_NUM;
    version_ptr->internal = LLF_RND_INTERNAL_VERSION_NUM;

    return;

 }/* END OF LLF_RND_GetVersion */
