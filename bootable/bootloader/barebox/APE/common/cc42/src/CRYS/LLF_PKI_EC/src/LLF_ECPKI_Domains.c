 ...
 *                    Actual data is given in little endian                        *
 ***********************************************************************************/

 const CRYS_ECPKI_Domain_t LLF_EC_DOMAINS_ARRAY [] = {

/***********  One Empty Domain ID = 0 *************/
	 { {0 },{0 },{0 },{0 },{0 },{0 },0x0,{0 },0x0,0x0,0x0,0x0,{{0 },{0 }},0x0,0x0 },

/******************** CRYS_ECPKI_DomainID_WMDRM10 = 1 *******************/
{
	/* Field modulus :  GF_Modulus = P = 785963102379428822376694789446897396207498568951 */
	{0x141424F7,0x31415926,0x27182818,0x01234567,0x89ABCDEF,0x00000000},
    /* EC equation parameters a, b :  */
    /* a = 317689081251325503476317476413827693272746955927 */
    {0xEBE41497,0x4780C009,0x7632FF3D,0xD277BCE8,0x37A5ABCC,0x00000000},
	/* b = 79052896607878758718120572025718535432100651934 */
	{0x9328239E,0xD78FDEDF,0x28E85F1A,0x725E2F32,0x0DD8DABF,0x00000000},

	/* Order of generator: r = 785963102379428822376693024881714957612686157429 - big end decimal*/
	{0x28C2A675,0xEC149044,0x2716B26E,0x01234567,0x89ABCDEF,0x00000000},

	 /* Generator  coordinateX -  771507216262649826170648268565579889907769254176 */
	{0x109FA120,0xBA38DAF0,0x3510C07D,0xD6A3A1E5,0x8723947F,0x00000000},
	  /* Generator  coordinateY - 390157510246556628525279459266514995562533196655 */
	{0xA379936F,0xD4ED7ACD,0x8C3C5856,0x1075522D,0x44574491,0x00000000},

	1, /* EC cofactor K */
	/* EC cofactor inverse EC_CofactorInv !!!!!!  Not inserted right  !!!! */
	{0x00000000},

	160, /* Size of field modulus in bits */
	5,   /* Size of field modulus in words*/
	160, /* Size of generator in bits */
	5,   /* Size of generator in words*/

	{
		/* Barrett tags NP,RP */
		{0x1390BC9B,0x80EB0615,0x625F1619,0xC08767E6,0x0000001D},
		{0x7F2D0A01,0x813BC68C,0x625F1619,0xC08767E6,0x0000001D}
	},

	CRYS_ECPKI_DomainID_WMDRM10,  /* EC Domain identifier - enum */
	GFp    /* EC finite field identifier - enum */
},

 /******  EC Domain: CRYS_ECPKI_DomainID_secp160k1 = 2
           / Data in ordinary little end representation  ****/
 {
  ...
  /****** EC Domain: CRYS_ECPKI_DomainID_secp160r1 = 3
           / Data in ordinary little end representation  ****/
{
...
/****** EC Domain: CRYS_ECPKI_DomainID_secp160r2 = 4
           / Data in ordinary little end representation  ****/
{	/* Field modulus :  GF_Modulus = P = FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73*/
	{0xFFFFAC73,0xFFFFFFFE,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF},
    /* EC equation parameters a, b  */
 ...
 /****** EC Domain: CRYS_ECPKI_DomainID_secp192k1 = 5
           / Data in ordinary little end representation  ****/
	{
...
/****** EC Domain: CRYS_ECPKI_DomainID_secp192r1 = 6
           / Data in ordinary little end representation  ****/
	{
    ...
    /****** EC Domain: CRYS_ECPKI_DomainID_secp224k1 = 7
           / Data in ordinary little end representation  ****/
	{
    ...
    /****** EC Domain: CRYS_ECPKI_DomainID_secp224r1 = 8
           / Data in ordinary little end representation  ****/
	{
...
/****** EC Domain: CRYS_ECPKI_DomainID_secp256k1
           / Data in ordinary little end representation  ****/
{
...
/****** EC Domain: CRYS_ECPKI_DomainID_secp256r1 / Data in ordinary little end representation  ****/
...
/******    EC Domain: CRYS_ECPKI_DomainID_secp384r1
           Data in ordinary little end representation        ****/
{
...
/****** EC Domain: CRYS_ECPKI_DomainID_secp521r1 / Data in ordinary little end representation  ****/
