    ...
    /*----------- Global function prototypes -------------------------------------*/
     /*Utility services*/
        ...
        **/
		...
		/*!
		\brief 
		Get the caller ID byte array

		@param callerId_ptr				[in]  pointer to a byte array
		@param callerIdLen				[in]  size of the byte array. size must be bigger that 32 bytes.

		@return SST_RC_OK The operation completed successfully.
		@return SST_RC_ERROR_INVALID_PARAM The callerIdLen param is less than 32 bytes.
		@return SST_RC_ERROR_NULL_POINTER At least one of the past arguments is null.
		**/
