...
*/
CEXPORT_C CRYSError_t CRYS_ECDSA_SignUpdate_ExtApp( CRYS_ECDSA_SignUserContext_t  *SignUserContext_ptr,  /*in/out*/
												   DxUint8_t                     *MessageDataIn_ptr,    /* in */ 
												   DxUint8_t                     *SepMessageDataIn_ptr,    /* in */ 
												   DxUint32_t                     DataInSize            /* in */ );
...
CRYS_ECDSA_SIGN_INVALID_DOMAIN_ID_ERROR <br>			 
**/
CEXPORT_C CRYSError_t CRYS_ECDSA_Sign_ExtApp(CRYS_ECDSA_SignUserContext_t  *SignUserContext_ptr,     /*in/out*/
											 CRYS_ECPKI_UserPrivKey_t      *SignerPrivKey_ptr,       /*in*/
											 CRYS_ECPKI_HASH_OpMode_t       HashMode,                /*in*/
											 DxUint8_t                     *MessageDataIn_ptr,       /*in*/ 
											 DxUint8_t                     *SepMessageDataIn_ptr,    /*in*/ 
...
CRYS_ECDSA_VERIFY_ILLEGAL_HASH_OP_MODE_ERROR <br>
**/
CEXPORT_C CRYSError_t CRYS_ECDSA_VerifyUpdate_ExtApp(CRYS_ECDSA_VerifyUserContext_t *VerifyUserContext_ptr, /*in/out*/
	                                                 DxUint8_t                      *MessageDataIn_ptr,     /* in */ 
	                                                 DxUint8_t                      *SepMessageDataIn_ptr,     /* in */ 
	                                                 DxUint32_t                      DataInSize             /* in */ );
...
**/
CEXPORT_C CRYSError_t CRYS_ECDSA_Verify_ExtApp ( 
	CRYS_ECDSA_VerifyUserContext_t *VerifyUserContext_ptr, /*in/out*/
	CRYS_ECPKI_UserPublKey_t       *UserPublKey_ptr,        /*in*/
	CRYS_ECPKI_HASH_OpMode_t        HashMode,               /*in*/
	DxUint8_t                      *SignatureIn_ptr,        /*in*/
