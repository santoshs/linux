...
#ifndef CRYS_HMAC_LOCAL_H
#define CRYS_HMAC_LOCAL_H
...
extern "C"
{
   ...
   *
   *  \version CRYS_HMAC_Local.h#1:incl:1
   *  \author R.Levin
   */
...
#define RETURN_IF_HMAC_UNSUPPORTED( a , b , c , d , e , f , g , h , i , j ) \
