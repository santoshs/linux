...
#define CRYS_HASH_DATA_IN_LLI_TAB_POINTER_INVALID_ERROR (CRYS_HASH_MODULE_ERROR_BASE + 0x6UL)
#define CRYS_HASH_DATA_IN_LLI_TAB_SIZE_INVALID_ERROR    (CRYS_HASH_MODULE_ERROR_BASE + 0x7UL)
#define CRYS_HASH_DATA_SIZE_IS_ILLEGAL_FOR_CSI_ERROR    (CRYS_HASH_MODULE_ERROR_BASE + 0x8UL)
#define CRYS_HASH_FIPS_MODE_FAIL_ERROR									(CRYS_HASH_MODULE_ERROR_BASE + 0x9UL)
#define CRYS_HASH_FIPS_MODE_SF_NOT_PERFORMED_ERROR			(CRYS_HASH_MODULE_ERROR_BASE + 0xAUL)
#define CRYS_HASH_FIPS_MODE_NOT_ALLOWED_ERROR						(CRYS_HASH_MODULE_ERROR_BASE + 0xBUL)
