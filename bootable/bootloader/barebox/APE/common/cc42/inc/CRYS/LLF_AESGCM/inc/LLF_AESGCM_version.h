...
#ifndef LLF_AESGCM_version_H
#define LLF_AESGCM_version_H
...
extern "C"
{
   ...
   */
  /** @file
   *  \brief This file contains the prototype of LLF_AESGCM_GetVersion function.
   *
   *  \version LLF_AESGCM_version.h#1:incl:1
   *  \author R.Levin
   */
