...
#define CRYS_RSA_FIPS_MODE_FAIL_ERROR										(CRYS_RSA_MODULE_ERROR_BASE + 0x41UL)
#define CRYS_RSA_FIPS_MODE_SF_NOT_PERFORMED_ERROR				(CRYS_RSA_MODULE_ERROR_BASE + 0x42UL)
