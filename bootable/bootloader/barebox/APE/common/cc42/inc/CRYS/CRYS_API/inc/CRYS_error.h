...
#define AESGCM_ERROR_IDX      0x18UL
...
/* AESCCM module on the LLF layer base address -  0x00F11500 */
...
/* AESGCM module on the CRYS layer base address - 0x00F01800 */
#define CRYS_AESGCM_MODULE_ERROR_BASE  (CRYS_ERROR_BASE + \
	                                   (CRYS_ERROR_LAYER_RANGE * CRYS_LAYER_ERROR_IDX) + \
	                                   (CRYS_ERROR_MODULE_RANGE * AESGCM_ERROR_IDX ) )  

/* AESGCM module on the LLF layer base address -  0x00F11800 */
#define LLF_AESGCM_MODULE_ERROR_BASE  (CRYS_ERROR_BASE + \
                                      (CRYS_ERROR_LAYER_RANGE * LLF_LAYER_ERROR_IDX) + \
                                      (CRYS_ERROR_MODULE_RANGE * AESGCM_ERROR_IDX ) ) 
