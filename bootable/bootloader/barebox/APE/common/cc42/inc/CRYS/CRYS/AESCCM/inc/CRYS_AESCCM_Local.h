...
#ifndef CRYS_AESCCM_LOCAL_H
#define CRYS_AESCCM_LOCAL_H
...
extern "C"
{
   ...
   *
   *  \version CRYS_AESCCM_Local.h#1:incl:1
   *  \author R.Levin
   */
...
#define AESCCM_CONTEXT_VALIDATION_TAG   0xAE50CC00
