...
INC6   = ../../../inc
INC7   = ../src
INC    = -I$(INC0) -I$(INC1) -I$(INC2) -I$(INC3) -I$(INC4) -I$(INC5) -I$(INC6) -I$(INC7)
SRC    = ../src
#####USBDEVICE#####
...
VPATH = $(INC0):$(INC1):$(INC2):$(INC3):$(INC4):$(INC5):$(INC6):$(INC7):$(SRC):$(SRCUSBCM):$(SRCUSBHS):$(SRCVCOM)
...
usb_init.o          : usb_api.h usb_private.h cpu_register.h com_type.h
...
usb_open.o          : usb_api.h usb_private.h usb_download.h comm_acm_dev_api.h comm_acm_dev_vcom.h c_def596.h\
...
usb_common.o        : usb_api.h usb_private.h usb_download.h comm_acm_dev_api.h usbf_api.h c_def596.h\
