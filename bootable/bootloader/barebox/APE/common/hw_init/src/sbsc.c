...
/**
 * SBSC_Init_ES20 - SBSC initialize process
 * @return None
 */
void SBSC_Init_ES20(void)
{
	ulong work;
	*CPG_PLLECR &= ~CPG_PLLECR_PLL3E;
	...
	*SBSC_SDCR0A    = SBSC_SDCR0A_DATA;
	*SBSC_SDCR1A    = SBSC_SDCR1A_DATA;
	*SBSC_SDWCRC0A  = SBSC_SDWCRC0A_DATA2;
	*SBSC_SDWCRC1A  = SBSC_SDWCRC1A_DATA2;
	*SBSC_SDWCRC2A  = SBSC_SDWCRC2A_DATA2;
	*SBSC_SDWCR00A  = SBSC_SDWCR00A_DATA2;
	
	*SBSC_SDWCR01A  = SBSC_SDWCR01A_DATA2;
	*SBSC_SDWCR10A  = SBSC_SDWCR10A_DATA2;
	*SBSC_SDWCR11A  = SBSC_SDWCR11A_DATA2;
	...
	*SBSC_SDPCRA   |= SBSC_SDPCRA_DATA;
	...
	if(!SYSC_SWReset_Flag()){
		...
		*SBSC_SDMRA_00000 = SBSC_SDMRA_DONE;
		*SBSC_SDMRACR0A   = SBSC_SDMRACR0A_DATA2;
		*SBSC_SDMRA_00000 = SBSC_SDMRA_DONE;
	}/* Skip some SBSC setting flow when SW reset would occur due to power mode 3 setting*/
