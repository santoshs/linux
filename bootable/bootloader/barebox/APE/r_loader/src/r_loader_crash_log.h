...
#define KMSG_SIZE_DDR            (0x20000) /* 128KB */
#define LOGCAT_MAIN_OFFSET_DDR   (KMSG_OFFSET + KMSG_SIZE_DDR)
#define LOGCAT_MAIN_SIZE_DDR     (0x20000) /* 128KB */
#define LOGCAT_SYSTEM_OFFSET_DDR (LOGCAT_MAIN_OFFSET_DDR + LOGCAT_MAIN_SIZE_DDR)
#define LOGCAT_SYSTEM_SIZE_DDR   (0x20000) /* 128KB */
#define LOGCAT_RADIO_OFFSET_DDR  (LOGCAT_SYSTEM_OFFSET_DDR + LOGCAT_SYSTEM_SIZE_DDR)
#define LOGCAT_RADIO_SIZE_DDR    (0x20000)  /* 128KB */
#define LOGCAT_EVENTS_OFFSET_DDR (LOGCAT_RADIO_OFFSET_DDR + LOGCAT_RADIO_SIZE_DDR)
#define LOGCAT_EVENTS_SIZE_DDR   (0x20000)  /* 128KB */
...
#ifdef STORE_CRASHLOG_DDR
#define RESET_LOG_ADDRESS_DDR (TMPLOG_BASE_ADDRESS + RESET_TMPLOG_SIZE)
#endif //STORE_CRASHLOG_DDR
