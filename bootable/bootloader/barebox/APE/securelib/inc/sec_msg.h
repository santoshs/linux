...
#if defined (SECURE_ENVIRONMENT) && defined (SEC_ENABLE_TRACES)

/*
#define sec_msg_trace(msg) _sec_msg_trace(msg)
char *_sec_msg_trace(sec_msg_t *msg);
*/

#define sec_msg_trace(msg)
