...
/** @brief Logical ID for memory card. 
 */
typedef enum
{
    HAL_MEMCARD_CARD0,
...
typedef enum
{
    ...
    HAL_MEMCARD_CMD_TIMEOUT         = 5,    /**< Command timeout occurred */
    HAL_MEMCARD_DATA_TIMEOUT        = 6,    /**< Data timeout occurred */
    HAL_MEMCARD_CMD_CRC_ERROR       = 7,    /**< Command CRC error occurred */
    HAL_MEMCARD_DATA_CRC_ERROR      = 8     /**< Data CRC error occurred */
} HAL_MEMCARD_RETURN; 
...
typedef enum
{
    HAL_MEMCARD_READ    = 0,    /**< read */
    HAL_MEMCARD_WRITE   = 1     /**< write */
...
typedef enum
{
    HAL_MEMCARD_DATA_WIDTH_1_BIT    = 0,
    HAL_MEMCARD_DATA_WIDTH_4_BIT    = 1,
    HAL_MEMCARD_DATA_WIDTH_8_BIT    = 2
...
typedef enum
{
    HAL_MEMCARD_CARD_IS_IN  = 0,
    HAL_MEMCARD_CARD_IS_OUT = 1,
...
{
    HAL_MEMCARD_RESPONSE_NONE       = 0x00000,
    HAL_MEMCARD_RESPONSE_R1         = 0x00100,
    HAL_MEMCARD_RESPONSE_R1b        = 0x00200,
    HAL_MEMCARD_RESPONSE_R2         = 0x00300,
    HAL_MEMCARD_RESPONSE_R3         = 0x00400,
    HAL_MEMCARD_RESPONSE_R4         = 0x00500,
    HAL_MEMCARD_RESPONSE_R5         = 0x00600,
    HAL_MEMCARD_RESPONSE_R6         = 0x00700,
    HAL_MEMCARD_RESPONSE_R7         = 0x00800,
    HAL_MEMCARD_RESPONSE_TYPE_MASK  = 0x00f00
...
{
    HAL_MEMCARD_COMMAND_TYPE_BC         = 0x00000,
    HAL_MEMCARD_COMMAND_TYPE_BCR        = 0x01000,
    HAL_MEMCARD_COMMAND_TYPE_AC         = 0x02000,
    HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE = 0x03000,
    HAL_MEMCARD_COMMAND_TYPE_ADTC_READ  = 0x04000,
    HAL_MEMCARD_COMMAND_TYPE_MASK       = 0x07000
...
{
    HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON    = 0x00000,
    HAL_MEMCARD_COMMAND_CARD_TYPE_MMC       = 0x08000,
    HAL_MEMCARD_COMMAND_CARD_TYPE_SD        = 0x10000,
    HAL_MEMCARD_COMMAND_CARD_TYPE_MASK      = 0x18000
...
{
    HAL_MEMCARD_COMMAND_NORMAL          = 0x00000,
    HAL_MEMCARD_COMMAND_APP             = 0x20000,
    HAL_MEMCARD_COMMAND_APP_NORM_MASK   = 0x20000
