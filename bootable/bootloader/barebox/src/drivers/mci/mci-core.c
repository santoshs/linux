...
static int mmc_change_freq(struct device_d *mci_dev)
{
	...
	mci->card_caps |= MMC_MODE_4BIT | MMC_MODE_8BIT;
	...
	if (ext_csd[212] || ext_csd[213] || ext_csd[214] || ext_csd[215]){
		mci->high_capacity = 1;
	/* Start adding */
		/* Set correct capacify info for high capacity cards */
		mci->capacity = ext_csd[212] << 0 | ext_csd[213] << 8 | ext_csd[214] << 16 | ext_csd[215] << 24;
