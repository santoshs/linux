...
#include "zinitix_touch_zxt_firmware(ZI02220C).h"
#include "zinitix_touch_zxt_firmware(ZI03220D).h"
...
//	touch_dev->cap_info.Orientation |= TOUCH_H_FLIP;
