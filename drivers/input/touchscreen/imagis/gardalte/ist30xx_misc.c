			   ...
			   char *buf)
{
	...
	buf[0] = '\0';
	buf_cnt = sprintf(buf, "tracking touch status\n");
...
/* sysfs  */
static DEVICE_ATTR(mem, 777 /*S_IRWXUGO*/, ist30xx_mem_show, ist30xx_mem_store);
static DEVICE_ATTR(refresh, 777 /*S_IRWXUGO*/, ist30xx_frame_refresh, NULL);
static DEVICE_ATTR(filter, 777 /*S_IRWXUGO*/, ist30xx_filter_show, NULL);
static DEVICE_ATTR(raw, 777 /*S_IRWXUGO*/, ist30xx_raw_show, NULL);
static DEVICE_ATTR(base, 777 /*S_IRWXUGO*/, ist30xx_base_show, NULL);
static DEVICE_ATTR(diff, 777 /*S_IRWXUGO*/, ist30xx_diff_show, NULL);
static DEVICE_ATTR(clb, 777 /*S_IRWXUGO*/, ist30xx_calib_show, ist30xx_calib_store);
static DEVICE_ATTR(debug, 777 /*S_IRWXUGO*/, NULL, ist30xx_debug_store);
static DEVICE_ATTR(tsp_power, 777 /*S_IRWXUGO*/, NULL, ist30xx_power_store);
static DEVICE_ATTR(errcnt, 777 /*S_IRWXUGO*/, NULL, ist30xx_errcnt_store);

static DEVICE_ATTR(regcmd, 777 /*S_IRWXUGO*/, tunes_regcmd_show, tunes_regcmd_store);
static DEVICE_ATTR(reg, 777 /*S_IRWXUGO*/, tunes_reg_show, tunes_reg_store);
static DEVICE_ATTR(tunes_fw, 777 /*S_IRWXUGO*/, NULL, tunes_fw_store);
static DEVICE_ATTR(tunes_param, 777 /*S_IRWXUGO*/, NULL, tunes_param_store);
static DEVICE_ATTR(adb, 777 /*S_IRWXUGO*/, tunes_adb_show, tunes_adb_store);
#if IST30XX_TRACKING_MODE
static DEVICE_ATTR(track, 777 /*S_IRWXUGO*/, ist30xx_track_show, NULL);
#endif
