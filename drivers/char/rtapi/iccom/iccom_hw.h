...
#define SYSC_PSTR		(SYSC_BASE_ADDR + 0x0080)
#define SYSC_RESCNT		(SYSC_BASE_ADDR + 0x801C)

/* CPGA */
#define CPGA_BASE_ADDR	(0xE6150000)
#define CPGA_MSTPSR0	(CPGA_BASE_ADDR + 0x0030)
#define CPGA_MSTPSR2	(CPGA_BASE_ADDR + 0x0040)
#define CPGA_RMSTPCR0	(CPGA_BASE_ADDR + 0x0110)
#define CPGA_RMSTPCR2	(CPGA_BASE_ADDR + 0x0118)
