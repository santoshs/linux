...
*   This configuration file is for SMC between EOS3 devices APE and Modem WGEM5.0
*
...
#ifndef SMC_INSTANCE_CONFIG_EOS3_U3CA_L2MUX_H
#define SMC_INSTANCE_CONFIG_EOS3_U3CA_L2MUX_H

#define SMC_CONFIG_NAME_EOS3_U3CA_ES1                    "EOS3-U3CA-ES1-WGEModem50-L2MUX"

#define SMC_CONF_COUNT_L2MUX                         1
#define SMC_CONF_CHANNEL_COUNT_L2MUX_EOS3            3
 ...
 * Slave  = Modem
 */
static smc_instance_conf_channel_t smc_instance_conf_l2mux_channels[SMC_CONF_CHANNEL_COUNT_L2MUX_EOS3] =
{
    {
            .name                = "ETH_P_PHONET",
            ...
            .mdb_size_slave      = 1024*256,
                 ...
                 */
            .signal_id_master_to_slave     = 75,             /* INTGEN IRQ_CPU_Int_Gen_Ch1 */
            ...
            .signal_type_master_from_slave = 0x03000006,      /* SMC_SIGNAL_TYPE_INT_RESOURCE         */
                 ...
                 */
            .signal_id_slave_to_master     = 13,              /* WGM_Modem_interrupts[1] --> INTC-SYS, Modem IntGen OUT 1 == SPI 194  */
            .signal_type_slave_to_master   = 0x03000004,     /* SMC_SIGNAL_TYPE_INT_GOP001    */

            .signal_id_slave_from_master   = 75,             /* INTGEN IRQ_CPU_Int_Gen_Ch1 */
     ...
     },
     {
             ...
             .mdb_size_slave      = 1024*256,
                  ...
                  * Master side signal configuration
                  */
             .signal_id_master_to_slave     = 76,             /* INTGEN IRQ_CPU_Int_Gen_Ch2 */
             .signal_type_master_to_slave   = 0x03000001,     /* SMC_SIGNAL_TYPE_INTGEN */
             ...
             .signal_type_master_from_slave = 0x03000006,      /* SMC_SIGNAL_TYPE_INT_RESOURCE         */
                  ...
                  * Slave side signal configuration
                  */
             .signal_id_slave_to_master     = 14,              /* WGM_Modem_interrupts[2] --> INTC-SYS, Modem IntGen OUT 2 == SPI 195 */
             .signal_type_slave_to_master   = 0x03000004,     /* SMC_SIGNAL_TYPE_INT_GOP001    */

             .signal_id_slave_from_master   = 76,             /* INTGEN IRQ_CPU_Int_Gen_Ch2 */
             .signal_type_slave_from_master = 0x03000001,     /* SMC_SIGNAL_TYPE_INTGEN */
     ...
     },
     {
             ...
             .mdb_size_slave      = 1024*1600,          /* Slave to master MDB (Typically DL) */
                  ...
                  * Master side signal configuration
                  */
             .signal_id_master_to_slave     = 77,             /* INTGEN IRQ_CPU_Int_Gen_Ch3 */
             .signal_type_master_to_slave   = 0x03000001,     /* SMC_SIGNAL_TYPE_INTGEN */
             ...
             .signal_type_master_from_slave = 0x03000006,      /* SMC_SIGNAL_TYPE_INT_RESOURCE         */
                  ...
                  * Slave side signal configuration
                  */
             .signal_id_slave_to_master     = 15,              /* WGM_Modem_interrupts[3] --> INTC-SYS, Modem IntGen OUT 15 == SPI 196 */
             .signal_type_slave_to_master   = 0x03000004,     /* SMC_SIGNAL_TYPE_INT_GOP001    */

             .signal_id_slave_from_master   = 77,             /* INTGEN IRQ_CPU_Int_Gen_Ch3 */
             .signal_type_slave_from_master = 0x03000001,     /* SMC_SIGNAL_TYPE_INTGEN */
...
static smc_instance_conf_t smc_instance_conf_l2mux[SMC_CONF_COUNT_L2MUX] =
{
     ...
     */
    {
        ...
        .shm_start_address            = SMC_CONF_L2MUX_SHM_START_ES1,
        .shm_size                     = SMC_CONF_L2MUX_SHM_SIZE_ES1,
        ...
        .channel_config_count         = SMC_CONF_CHANNEL_COUNT_L2MUX_EOS3,
