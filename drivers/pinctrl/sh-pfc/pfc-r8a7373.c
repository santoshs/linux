...
static const struct pinmux_func pinmux_func_gpios[] = {
	...
	GPIO_FN(IRQ31),
	GPIO_FN(SCIFA0_CTS_), GPIO_FN(SCIFA2_CTS_), GPIO_FN(SF_IRQ_01), GPIO_FN(SIM1_DET), GPIO_FN(IRQ32),
	GPIO_FN(SCIFA0_SCK), GPIO_FN(SCIFA2_SCK), GPIO_FN(SIM0_PWRON), GPIO_FN(IRQ33),
	GPIO_FN(SCIFA1_RTS_), GPIO_FN(SCIFA3_RTS_), GPIO_FN(SIM1_PWRON), GPIO_FN(IRQ34),
	GPIO_FN(SCIFA1_CTS_), GPIO_FN(SCIFA3_CTS_), GPIO_FN(SIM0_VOLTSEL0), GPIO_FN(IRQ35),
	GPIO_FN(SCIFA1_SCK), GPIO_FN(SCIFA3_SCK), GPIO_FN(PORT36_TPU0TO0), GPIO_FN(SIM0_VOLTSEL1),
	GPIO_FN(IRQ36),
	GPIO_FN(SCIFB0_RTS_), GPIO_FN(TPU0TO1), GPIO_FN(SCIFB3_RTS_), GPIO_FN(SIM1_VOLTSEL0),
	GPIO_FN(IRQ37),
	GPIO_FN(SCIFB0_CTS_), GPIO_FN(SCIFB2_SCK), GPIO_FN(TPU0TO2), GPIO_FN(SCIFB3_CTS_),
	GPIO_FN(SIM1_VOLTSEL1), GPIO_FN(IRQ38),
	GPIO_FN(SCIFB0_SCK), GPIO_FN(SCIFB1_SCK), GPIO_FN(TPU0TO3), GPIO_FN(SCIFB3_SCK), GPIO_FN(IRQ39),
	...
	GPIO_FN(IC_DP),
	GPIO_FN(IC_DM),
	GPIO_FN(HSI_RX_FLAG), GPIO_FN(SCIFB2_TXD), GPIO_FN(MSIOF3_TXD), GPIO_FN(PORT72_GIO_OUT4),
	GPIO_FN(HSI_RX_DATA), GPIO_FN(SCIFB2_RXD), GPIO_FN(MSIOF3_RXD), GPIO_FN(PORT73_GIO_OUT5),
	GPIO_FN(HSI_TX_READY), GPIO_FN(SCIFB2_RTS), GPIO_FN(MSIOF3_SCK), GPIO_FN(PORT74_GIO_OUT0),
	GPIO_FN(HSI_RX_WAKE), GPIO_FN(SCIFB2_CTS), GPIO_FN(MSIOF3_SYNC), GPIO_FN(GenIO4), GPIO_FN(IRQ59),
	...
	GPIO_FN(MSIOF1_TXD), GPIO_FN(I2C_SCL0H), GPIO_FN(SF_I2C_SCL0H), GPIO_FN(MSIOF5_TXD),
	GPIO_FN(MSIOF1_RXD), GPIO_FN(I2C_SDA0H), GPIO_FN(SF_I2C_SDA0H), GPIO_FN(MSIOF5_RXD),
	GPIO_FN(MSIOF1_SCK), GPIO_FN(I2C_SCL1H), GPIO_FN(SF_I2C_SCL1H), GPIO_FN(MSIOF5_SCK),
	GPIO_FN(MSIOF1_SYNC), GPIO_FN(I2C_SDA1H), GPIO_FN(SF_I2C_SDA1H), GPIO_FN(MSIOF5_SYNC),
	GPIO_FN(MSIOF0_SS1), GPIO_FN(SCIFA2_TXD),
	GPIO_FN(MSIOF1_SS1), GPIO_FN(SCIFA2_RXD), GPIO_FN(MSIOF5_SS1),
	GPIO_FN(MSIOF1_SS1), GPIO_FN(PORT90_SCIFA3_TXD),	/* Port90 */
	...
	GPIO_FN(WE0_N), GPIO_FN(PORT225_TPU0TO0), GPIO_FN(PORT225_RDWR), GPIO_FN(IRQ53),
	...
	GPIO_FN(SDHID2_1), GPIO_FN(MSIOF1_SS2), GPIO_FN(SF_IRQ_02), GPIO_FN(MSIOF6_SS2), GPIO_FN(IRQ62),
	GPIO_FN(SDHID2_2), GPIO_FN(MSIOF4_RXD), GPIO_FN(MSIOF6_RXD),
	GPIO_FN(SDHID2_3), GPIO_FN(MSIOF4_SYNC), GPIO_FN(MSIOF6_SYNC),
	GPIO_FN(SDHICMD2), GPIO_FN(MSIOF1_SS1), GPIO_FN(SF_PORT_00), GPIO_FN(MSIOF6_SS1),
