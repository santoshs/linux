...
#define MSG(...)	printk("TST: " __VA_ARGS__);printk("\n");
...
#define MSG_INFO(...)	printk(KERN_INFO __VA_ARGS__);printk("\n");
...
#define FUNC_MSG_RET(ret)	MSG("<< %s (%d)", __func__, ret);\
							return ret;
...
static ssize_t _name##_mod_show(struct kobject *, struct kobj_attribute *,\
			  char *);\
static ssize_t _name##_mod_show(struct kobject *kobj, struct kobj_attribute *attr,\
			  char *buf)\
{\
	int ret = 0; \
	char *s = NULL;\
...
static ssize_t _name##_mod_store(struct kobject *, struct kobj_attribute *,\
			   const char *, size_t);\
static ssize_t _name##_mod_store(struct kobject *kobj, struct kobj_attribute *attr,\
