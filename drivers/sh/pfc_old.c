			    ...
			    unsigned gpio, int new_pinmux_type)
{
    ...
    //### RMC ### Sample Code Start
    if (new_pinmux_type == PINMUX_TYPE_INPUT) {
      if (gpio == GPIO_PORT273) { // for NFC PN544
        __raw_writeb(0x20, 0xE6052111u); /* PORT273CR.IE */
        return(0);
      }
      if (gpio == GPIO_PORT274) { // for NFC PN544
        __raw_writeb(0x20, 0xE6052112u); /* PORT274CR.IE */
        return(0);
      }
    }
    else if (new_pinmux_type == PINMUX_TYPE_OUTPUT) {
      if (gpio == GPIO_PORT273) { // for NFC PN544
        __raw_writeb(0x10, 0xE6052111u); /* PORT273CR.OE */
        return(0);
      }
      if (gpio == GPIO_PORT274) { // for NFC PN544
      __raw_writeb(0x10, 0xE6052112u); /* PORT274CR.OE */
      return(0);
      }
    }
    //### RMC ### Sample Code End
