...
#define SYSC_DBGPOWCR_C4CL   (   1 <<  0)
#define SYSC_DBGPOWCR_D4     (   1 <<  1)
#define SYSC_DBGPOWCR_A4SF   (   1 <<  4)
#define SYSC_DBGPOWCR_A4LC   (   1 <<  6)
#define SYSC_DBGPOWCR_A4MP   (   1 <<  8)
#define SYSC_DBGPOWCR_A3R0   (   1 << 11)
#define SYSC_DBGPOWCR_A4RM   (   1 << 12)
#define SYSC_DBGPOWCR_A3R1   (   1 << 13)
#define SYSC_DBGPOWCR_A2RV   (   1 << 14)
#define SYSC_DBGPOWCR_A2RI   (   1 << 15)
#define SYSC_DBGPOWCR_C4     (   1 << 16)
#define SYSC_DBGPOWCR_A3SP   (   1 << 17)
#define SYSC_DBGPOWCR_A3SG   (   1 << 18)
#define SYSC_DBGPOWCR_A3SM   (   1 << 19)
#define SYSC_DBGPOWCR_A2SL   (0x1F << 20)
#define SYSC_DBGPOWCR_ALL_POWER_DOWN_ALLOWED (0x01FFF953)

#define SYSC_RESCNT       0xE618801C

#define CPG_PCCUCR        0xE6151180
#define CPG_PCCUCR_CKSTP_EN    (     1 << 24)
#define CPG_PCCUCR_RESET_EN    (  0x3F << 18)
#define CPG_PCCUCR_RESERVED    (0x3330 <<  0)
#define CPG_PCCUCR_ALL_INIT_VALUE (0x00003330)
...
static int rmc_loader_open(struct inode *inode, struct file *file)
{
	...
	if ((file->f_flags & O_ACCMODE) == O_WRONLY) {
		...
		printk(KERN_ALERT "4ETB: PCCUCR:  0x%08x\n", __raw_readl(CPG_PCCUCR));
		...
		if ((data & (DBGREG4_BB_NIDEN | DBGREG4_BB_DBGEN)) != (DBGREG4_BB_NIDEN | DBGREG4_BB_DBGEN)) {
		  ...
		  /* Allow SYS-CPU clock stop and reset control */
		  __raw_writel(CPG_PCCUCR_ALL_INIT_VALUE, CPG_PCCUCR);
		  /* Allow and do power down D4 since sec hal powers it up unnecessarily. */
		  /* Also allow power down of A3R1 since sec hal disallows that unnecessarily. */
		  __raw_writel(SYSC_DBGPOWCR_ALL_POWER_DOWN_ALLOWED, SYSC_DBGPOWCR);
