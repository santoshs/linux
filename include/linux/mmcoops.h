...
#define MMCOOPS_LOGCAT_MAIN_SIZE		128
#define MMCOOPS_LOGCAT_SYSTEM_SIZE		128
#define MMCOOPS_LOGCAT_RADIO_SIZE		128
...
#define MMCOOPS_LOCAL_VERSION	0x01F00085	/* kmsg+logcat  */
