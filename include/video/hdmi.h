...
#define IOC_SET_AESHDCP_KEY		_IOW(HDMI_IOC_MAGIC, 21, unsigned char[294])	

#define FIRST_TIMING_DESCRIPTOR_START 54
#define SECOND_TIMING_DESCRIPTOR_START 72
#define PIXEL_FREQUENCY_LOWBYTE 0
#define PIXEL_FREQUENCY_HIGHBYTE 1
#define HACTIVE_LOWBYTE 2
#define HACTIVE_HIGHNIBBLE 4
#define HBLANK_LOWBYTE 3
#define HBLANK_HIGHNIBBLE 4
#define VACTIVE_LOWBYTE 5
#define VACTIVE_HIGHNIBBLE 7
#define VBLANK_LOWBYTE 6
#define VBLANK_HIGHNIBBLE 7
#define VIDEOMODE 17



/* HDMI driver */
void hdmi_event(enum av7100_hdmi_event);
int hdmi_init(void);
void hdmi_exit(void);
void sethdmiOnOff(enum av7100_hdmi_mode);
